...
data = "Don't you know \"Python\"?"     # 백슬래스를 사용하면 큰따옴표, 작은따옴표를 문자열에 원하는 만큼 포함시킬 수 있음
print(data)
...
value_list = data.values()      # 값 데이터만 담은 리스트(?) 사전 자료형이 맞을 듯.
print(key_list)
print(value_list)
...
data.update([5, 6, 7])      # 새로운 원소 여러 개 추가
print(data)
